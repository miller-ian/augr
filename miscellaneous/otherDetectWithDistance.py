...
def determine_location(start, distance, bearing):
...
def overlay_on_image(display_image, object_info):
    ...
    #global distanceText
    #distanceText = str(distance) + " ft away"
...
def main():
    ...
    for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
        ...
        returnList = []
        print("distance from camera to head: " + str(distance) + "feet")
